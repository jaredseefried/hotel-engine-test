...
function FilterList(props) {
  return (
    <Dropdown.Item onClick={props.filterLanguage} value={props.language} id={props.language} className="dropdown-item" onChange={props.showLanguages}>{props.language}</Dropdown.Item>
  );
}
